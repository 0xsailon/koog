...
) = strategy<String, String>("single_run_with_history_compression_sequential") {
...
//    )
//    val nodeSendCompressedHistory by node<List<ReceivedToolResult>, List<Message.Assistant>> {
//        llm.writeSession {
//            requestLLMMultiple()
//        }
//    }
...
private fun singleRunWithHistoryCompressionModeStrategy(config: HistoryCompressionConfig) = strategy<String, String>("single_run_with_history_compression") {
...
//        retrievalModel = config.retrievalModel
//    )
//    val nodeSendCompressedHistory by node<ReceivedToolResult, Message.Assistant> {
//        llm.writeSession {
//            this.requestLLM()
//        }
//    }
