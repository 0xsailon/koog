...
public class ContextualPromptExecutor(
    ...
    override suspend fun execute(prompt: Prompt, model: LLModel, tools: List<ToolDescriptor>): Message.Assistant {
        ...
        try {
            ...
            context.pipeline.onLLMCallCompleted(eventId, context.executionInfo, context.runId, effectivePrompt, model, tools, response, moderationResponse = null, context)
            return response
        } catch (e: Throwable) {
    ...
    override suspend fun moderate(
        ...
        try {
            ...
            context.pipeline.onLLMCallCompleted(eventId, context.executionInfo, context.runId, effectivePrompt, model, tools = emptyList(), response = null, moderationResponse = result, context)
            return result
        } catch (e: Throwable) {
