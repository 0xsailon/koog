...
public class LLMClientIntegrationTest extends KoogJavaTestBase {
    ...
    private void assertValidResponse(List<Message.Assistant> responses) {
    ...
    public void integration_OpenAILLMClient() {
        ...
        List<Message.Assistant> responses = client.execute(prompt, OpenAIModels.Chat.GPT4o);
    ...
    public void integration_AnthropicLLMClient() {
        ...
        List<Message.Assistant> responses = client.execute(prompt, AnthropicModels.Haiku_4_5, Collections.emptyList());
    ...
    public void integration_MultiLLMPromptExecutor() {
        ...
        List<Message.Assistant> openAIResponses = executor.execute(openAIPrompt, OpenAIModels.Chat.GPT4o, Collections.emptyList());
        ...
        List<Message.Assistant> anthropicResponses = executor.execute(anthropicPrompt, AnthropicModels.Haiku_4_5);
