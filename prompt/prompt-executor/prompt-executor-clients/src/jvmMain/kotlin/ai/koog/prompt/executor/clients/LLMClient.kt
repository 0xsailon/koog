...
public actual abstract class LLMClient actual constructor() : LLMClientAPI, LLMEmbeddingProvider() {
    ...
    ): Message.Assistant = runOnIOBoundDispatcher(executorService) { execute(prompt, model, tools) }
    ...
    public fun executeMultipleChoices(
        ...
        tools: List<ToolDescriptor> = emptyList(),
        executorService: ExecutorService? = null
    ): LLMChoice = runOnIOBoundDispatcher(executorService) { executeMultipleChoices(prompt, model, tools) }
