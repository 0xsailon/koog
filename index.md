...
- [**Knowledge retrieval**](embeddings/)
  ...
  Retain and retrieve knowledge across conversations using [vector embeddings](embeddings/), [RAG](retrieval-augmented-generation/), and [shared agent memory](features/agent-memory/)
